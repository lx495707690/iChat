...
public class NumberPickerBuilder {
    ...
    public NumberPickerDialogFragment fragment;
    ...
    public void process(){
    	 fragment = NumberPickerDialogFragment
...
//        
	...
	public NumberPickerDialogFragment getFragment() {
		return fragment;
	}

	public void setFragment(NumberPickerDialogFragment fragment) {
