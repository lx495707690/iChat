...
public class CustomViewAbove extends ViewGroup {
	...
	public interface OnPageChangeListener {
		...
		public void onPageFinishScroll(int positionOffsetPixels);
	...
	public void setCurrentItem(int item) {
		setCurrentItemInternal(item, true, false, 0);
	}
	...
	public void setCurrentItem(int item, boolean smoothScroll) {
		setCurrentItemInternal(item, smoothScroll, false, 0);
	}

	/**
	 * Set the currently selected page with specific width
	 * 
	 * @param item
	 *            Item index to select
	 * @param smoothScroll
	 ...
	 *            Width to open
	 */
	public void setCurrentItem(int item, boolean smoothScroll, int width) {
		setCurrentItemInternal(item, smoothScroll, false, width);
		this.width = width;
	}
	...
	void setCurrentItemInternal(
			int item, boolean smoothScroll, boolean always, int width) {
		setCurrentItemInternal(item, smoothScroll, always, 0, width);
	}

	void setCurrentItemInternal(
			int item, boolean smoothScroll, boolean always, int velocity,
			int width) {
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			if (mIsBeingDragged) {
				...
				mOnPageChangeListener.onPageFinishScroll(scrollX);
				mInternalPageChangeListener.onPageFinishScroll(scrollX);
		...
		case MotionEvent.ACTION_CANCEL:
			if (mIsBeingDragged) {
				setCurrentItemInternal(mCurItem, true, true, 0);
				mActivePointerId = INVALID_POINTER;
				endDrag();
			}
			break;
